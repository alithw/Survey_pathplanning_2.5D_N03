...
\begin{abstract}
Báo cáo này trình bày các kết quả nghiên cứu bổ sung kể từ báo cáo trước đó (28/04/2026) của Nhóm 3. Nhóm đã mở rộng hệ thống quy hoạch đường đi 2.5D bằng cách \textbf{tích hợp thêm ba lớp đánh giá Traversability} (Hình học -- Geometric, Vật lý -- Physical, Ngữ nghĩa -- Semantic) vào pipeline tổng thể, đồng thời củng cố kết quả thực nghiệm A* và NMPC bằng các bảng số liệu chi tiết hơn. Toàn bộ mã nguồn Python được lưu tại thư mục \texttt{3. code} của dự án.
\end{abstract}

% ============================================================
\section{Tóm tắt tiến độ từ báo cáo trước đó (28/04/2026)}
% ============================================================

Nhóm 3 đã hoàn thiện các nội dung sau kể từ báo cáo trước đó:

\begin{enumerate}
    \item \textbf{Đã hoàn thiện (từ báo cáo trước):}
    \begin{itemize}
